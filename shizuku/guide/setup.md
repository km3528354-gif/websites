...
Starting with wireless debugging works on Android 11 or aboveerrj. This startup method does not require a connection to a computer. Due to system limitations, the startup steps need to be performed again after each reboot.
